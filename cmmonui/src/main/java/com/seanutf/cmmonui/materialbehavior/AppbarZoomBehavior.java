package com.seanutf.cmmonui.materialbehavior;
...
public class AppbarZoomBehavior extends AppBarLayout.Behavior {
    private static final String IVTAG = "ivParallax";
    private static final float MAX_ZOOM_HEIGHT = 2000;//放大最大高度
    ...
    private void init(AppBarLayout abl) {
        ...
        mImageView = abl.findViewWithTag(IVTAG);
        if (mImageView != null) {
            mImageViewHeight = mImageView.getHeight();
        } else {
            throw new RuntimeException("imageview必须设置tag");
        }
    }
