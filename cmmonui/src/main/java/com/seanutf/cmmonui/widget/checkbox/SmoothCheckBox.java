package com.seanutf.cmmonui.widget.checkbox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#888888");
    ...
    private int mWidth, mAnimDuration, mStrokeWidth, ex;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mTickPoints[0].y = Math.round((float) getMeasuredHeight() / 30 * 17);
        mTickPoints[1].x = Math.round((float) getMeasuredWidth() / 30 * 12);
        mTickPoints[1].y = Math.round((float) getMeasuredHeight() / 30 * 21);
        ...
        mTickPaint.setStrokeWidth(mStrokeWidth + 4);
    }
