...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private int IndicatorMarginBottom;//indicator距离底部的距离
    ...
    private void init() {
        ...
        if (IndicatorMarginBottom > 0) {
            FrameLayout.LayoutParams lp = (LayoutParams) mIndicatorContainer.getLayoutParams();
    ...
    public void setIndicatorMarginBottom(int value) {
        IndicatorMarginBottom = value;
    }
