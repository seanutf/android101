...
public class ExpandableTextView extends AppCompatTextView {
    ...
    private static final int TO_EXPAND_HINT_COLOR = 0x000000;
    private static final int TO_SHRINK_HINT_COLOR = 0x000000;
    private static final int TO_EXPAND_HINT_COLOR_BG_PRESSED = 0x000000;
    private static final int TO_SHRINK_HINT_COLOR_BG_PRESSED = 0x000000;
    ...
    private class TouchableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            //            }else{
            //                toggle();                ToastUtils.showToast("toggle");
            //
            //            }
        }
